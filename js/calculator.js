    var isIMCpublic = false;

        jQuery('.form_weight .wpcf7-submit').click(function($) {

            var name = jQuery('input[name="email-137"]').val();
            ...
            if(name.length != 0) {
                ...
                if (BMI >= 40) {
                    ...
                    img_bmi = '/wp-content/plugins/leadgenerator/img/obesity.jpg';
                    text_color = 'red';
                ...
                if (BMI >= 25 && BMI < 30) {
                    ...
                    img_bmi = '/wp-content/plugins/leadgenerator/img/overweight_last.jpg';
                    text_color = 'red';
                    text = 'Tienes sobrepeso';
                }
                if (BMI >= 18.5 && BMI < 25) {
                    ...
                    img_bmi = '/wp-content/plugins/leadgenerator/img/normal_weight.jpg';
                    text_color = 'green';
                ...
                if (BMI < 18.5) {
                    ...
                    img_bmi = '/wp-content/plugins/leadgenerator/img/underweight.jpg';
                    text_color = 'red';
